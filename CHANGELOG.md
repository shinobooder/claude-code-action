...
## Fork Changes (shinobooder/claude-code-action@beta)
...
- **Updated Base Action**: Uses `shinobooder/claude-code-base-action@beta` which includes OAuth credential handling
